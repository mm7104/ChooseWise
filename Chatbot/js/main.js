...
let intro = [
  ...
  "Hi, I am the Titan bot",
  "Hello, My name is Titan bot",
];
let help = [
...
function chatbotvoice(message) {
  ...
  speech.text =
    "I cannot understand your query , you can mail your quries at titans@gmail.com , regards titan bot.";
  ...
  if (
    message.includes("Where can i know about the developers of this project")
  ) {
