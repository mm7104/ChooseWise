...
st.markdown("<h3 style='text-align: center; color: Black;'>Drop in The required Inputs and we will do  the rest.</h3>", unsafe_allow_html=True)
st.markdown("<h4 style='text-align: center; color: Black;'>Project by Titans</h4>", unsafe_allow_html=True)

# components.html("<html><h1 style='text-align: center; color: White;background-color: Red'>School Admission Predictor</h1></html>")
# components.html("<html><h3 style='text-align: center; color: Black;'>Drop in The required Inputs and we will do  the rest.</h3></html>")
...
if nav == "I'll Just use the predictor":
    ...
    ss = st.number_input("Marks In Social Studies (200)",min_value = 0,max_value=200,value = 30,step = 10)
    ss = ss * (120/200)
    extra = st.radio("Do You have prior Extra curricular Experience",["No","Yes"])
    if extra == "No":
        extra = 0
    else :
        extra = 1
        st.slider("How would you rate yourself in these activities",1,10)
...
if nav == "YES! SHOW ME":
    ...
    plt.show()
    st.pyplot(plt)
>>>>>>> 5c9ab4ed1d8d07b5366455dd5797020e99b2624f
